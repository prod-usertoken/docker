...
#    root /home/www/www.usertoken.com/html;
#    index index.php index.html index.htm;

    access_log /var/log/nginx/www.usertoken.com.access.log;
    error_log /var/log/nginx/www.usertoken.com.error.log;
