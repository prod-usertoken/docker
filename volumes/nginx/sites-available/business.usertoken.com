server {
    listen   80;
    server_name business.usertoken.com;
...
#    root /home/www/business.usertoken.com/html;
#    index index.php index.html index.htm;

    access_log /var/log/nginx/business.usertoken.com.access.log;
    error_log /var/log/nginx/business.usertoken.com.error.log;
    error_page 404 /404.html;

    location / {
        proxy_pass http://172.0.0.1:9002;
