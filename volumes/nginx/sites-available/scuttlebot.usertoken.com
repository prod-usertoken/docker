server {
    listen   80;
    server_name scuttlebot.usertoken.com;
...
#    root /home/www/scuttlebot.usertoken.com/html;
#    index index.php index.html index.htm;

    access_log /var/log/nginx/scuttlebot.usertoken.com.access.log;
    error_log /var/log/nginx/scuttlebot.usertoken.com.error.log;
