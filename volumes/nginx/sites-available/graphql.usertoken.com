server {
    listen   80;
    server_name graphql.usertoken.com;
...
# for custom CSP headers use: http://cspbuilder.info
    ...
    #root /home/www/graphql.usertoken.com/html;
    #index index.php index.html index.htm;

    access_log /var/log/nginx/graphql.usertoken.com.access.log;
    error_log /var/log/nginx/graphql.usertoken.com.error.log;
